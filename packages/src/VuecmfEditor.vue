<template>
  <div class="editor-tool-bar">
    <template :key="index" v-for="(item, index) in editor_tool_config">
      <el-dropdown @command="item.fun" trigger="click" v-if=" ['heading','font','text-height'].indexOf(item.icon) !== -1 ">
        <el-button size="small" :title="item.tips">
      ...
      <el-button class="color_btn" size="small" :title="item.tips" v-else-if=" item.icon === 'glass-martini-alt' ">
        <el-color-picker v-model="color_value" size="mini" @change="item.fun" show-alpha :predefine="predefine_colors" />
      </el-button>

      <el-button class="color_btn" size="small" :title="item.tips" v-else-if=" item.icon === 'glass-martini' ">
          <el-color-picker v-model="bg_color_value"  size="mini" @change="item.fun" show-alpha :predefine="predefine_colors"  />
      </el-button>

      <el-button size="small" :title="item.tips" v-else-if=" item.icon === 'link' ">
        <font-awesome-icon :icon="item.icon" @click="link_dlg = true"></font-awesome-icon>
      </el-button>

      <el-button size="small" :title="item.tips" v-else-if=" item.icon === 'table' ">
        <font-awesome-icon :icon="item.icon" @click="table_dlg = true"></font-awesome-icon>
      </el-button>

      <el-button size="small" :title="item.tips" v-else-if=" item.icon === 'image' ">
        <font-awesome-icon :icon="item.icon" @click="image_dlg = true"></font-awesome-icon>
      </el-button>

      <el-button size="small" :title="item.tips" v-else-if=" item.icon === 'film' ">
        <font-awesome-icon :icon="item.icon" @click="video_dlg = true"></font-awesome-icon>
      </el-button>

      <el-button size="small" :title="item.tips" v-else-if=" item.icon === 'code' ">
        <font-awesome-icon :icon="item.icon" @click="code_dlg = true"></font-awesome-icon>
      </el-button>

      <el-button size="small" :title="item.tips" v-else-if=" item.icon === 'question-circle'">
        <font-awesome-icon :icon="item.icon" @click="about_dlg = true"></font-awesome-icon>
      </el-button>

      <el-button size="small" :title="item.tips" v-else>
  ...
  <el-dialog v-model="link_dlg" title="添加超链接">
    <el-form size="small" :inline="true">
      <el-form-item label="链接地址">
        <el-input size="small" v-model="link_url" placeholder="请以http://或https://开头"></el-input>
      </el-form-item>
      <el-form-item label="打开方式">
        <el-select v-model="link_target" placeholder="请选择" size="small">
    ...
    <template #footer>
      <el-button type="default" size="small"  @click="link_dlg = false">取消</el-button>
      <el-button type="primary" size="small"  @click="linkEvent">确定</el-button>
    </template>
  </el-dialog>
    ...
    <el-form size="small" :inline="true">
      <fieldset>
        ...
        <el-form-item label="边框">
          <el-color-picker v-model="table_border_color" size="mini"  show-alpha :predefine="predefine_colors"  />
        </el-form-item>
      </fieldset>
      ...
      <fieldset>
        <legend>列头</legend>
        <el-form-item>
          <el-select v-model="table_head" placeholder="请选择" size="small">
        ...
        <el-form-item label="背景色">
          <el-color-picker v-model="table_head_bg_color" size="mini"  show-alpha :predefine="predefine_colors"  />
        </el-form-item>
        <el-form-item label="文字颜色">
          <el-color-picker v-model="table_head_color" size="mini"  show-alpha :predefine="predefine_colors"  />
        </el-form-item>
      </fieldset>
    </el-form>
    <template #footer>
      <el-button type="default" size="small"  @click="table_dlg = false">取消</el-button>
      <el-button type="primary" size="small"  @click="insertTableEvent">确定</el-button>
    </template>
  </el-dialog>
  ...
  <el-dialog v-model="image_dlg" title="插入图片">
    <el-form size="small" :inline="true">
      <el-form-item label="地址">
        <el-input size="small" v-model="image_url" placeholder="请以http://或https://开头"></el-input>
      </el-form-item>
      <el-form-item label="宽度">
      ...
      <el-form-item label="对齐">
        <el-select v-model="image_align" placeholder="请选择" size="small">
    ...
    <template #footer>
      <el-button type="default" size="small"  @click="image_dlg = false">取消</el-button>
      <el-button type="primary" size="small"  @click="insertImageEvent">确定</el-button>
    </template>
  </el-dialog>
  ...
  <el-dialog v-model="video_dlg" title="插入视频">
    <el-form size="small" :inline="true">
      <fieldset>
        ...
        <el-form-item label="地址">
          <el-input size="small" v-model="video_url" placeholder="请以http://或https://开头"></el-input>
        </el-form-item>
        <el-form-item label="宽度">
        ...
        <el-form-item label="对齐">
          <el-select v-model="video_align" placeholder="请选择" size="small">
            <el-option label="左对齐" value="left"></el-option>
    ...
    <template #footer>
      <el-button type="default" size="small"  @click="video_dlg = false">取消</el-button>
      <el-button type="primary" size="small"  @click="insertVideoEvent">确定</el-button>
    </template>
  </el-dialog>
  ...
  <el-dialog v-model="code_dlg" title="插入代码">
    ...
    <template #footer>
      <el-button type="default" size="small"  @click="code_dlg = false">取消</el-button>
      <el-button type="primary" size="small"  @click="insertCodeEvent">确定</el-button>
    </template>
  </el-dialog>
  ...
  <el-dialog v-model="about_dlg" title="关于">
    ...
    <template #footer>
      <div class="about"><el-button type="default" size="small"  @click="about_dlg = false">关闭</el-button></div>
    </template>
  </el-dialog>
